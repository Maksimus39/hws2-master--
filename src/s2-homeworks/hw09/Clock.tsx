...
function Clock() {
    ...
    const start = () => {
        ...
        stop(); // Сначала останавливаем текущий таймер, если он запущен
        const id = window.setInterval(() => {
            setDate(new Date()); // Обновление состояния текущей датой
        }, 1000);
        setTimerId(id);
    }
    ...
    const stringTime = date.toLocaleTimeString([], {hour: '2-digit', minute: '2-digit', second: '2-digit'});
    const stringDate = date.toLocaleDateString('ru-Ru', {month: '2-digit', day: '2-digit', year: 'numeric'});
